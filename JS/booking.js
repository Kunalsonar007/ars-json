...
(async function () {
  try {
    ...
    let url = "https://flight-booking-json-l-git-cea0dd-abhay-dixits-projects-4f073080.vercel.app/bookings";
...
function handleEditClick(bookingId) {
  ...
  fetch(`https://flight-booking-json-l-git-cea0dd-abhay-dixits-projects-4f073080.vercel.app/bookings/${bookingId}`)

...
const airlineReg = async (id, name, iata_code, country) => {
  try {
    ...
    const url = id
      ? `https://flight-booking-json-l-git-cea0dd-abhay-dixits-projects-4f073080.vercel.app/airlines/${id}`
      : 'https://flight-booking-json-l-git-cea0dd-abhay-dixits-projects-4f073080.vercel.app/airlines';
